 ...
 *       &lt;sequence>
 *         &lt;element name="cp" type="{http://com.example.BanqueSI.WebServices/cp}cp" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getCpResponse", namespace = "http://com.example.BanqueSI.WebServices/cp")
public class GetCpResponse {

    @XmlElement(namespace = "http://com.example.BanqueSI.WebServices/cp", required = true)
    protected List<Cp> cp;
